    ...
    if not force_refresh:
        ...
        if cached is not None:
            ...
            if meta_path.exists():
                ...
                # Hard block: never allow synthetic GBM data into the strategy pipeline
                if "synthetic" in source.lower() or "gbm" in source.lower():
                    raise RuntimeError(
                        "\n\nSYNTHETIC DATA DETECTED IN CACHE — PIPELINE HALTED.\n\n"
                        "The cached data was generated by the synthetic GBM seeder and "
                        "must not be used for strategy research.\n\n"
                        "Provide real NIFTY 50 daily OHLC data, then run:\n"
                        "    python scripts/import_csv.py --file NIFTY_50_DAILY.csv\n\n"
            ...
            report = validate_ohlcv(cached, symbol, source, downloaded_at)
